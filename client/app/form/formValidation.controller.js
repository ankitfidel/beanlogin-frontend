(function () {
    ...
    angular.module('app.form.validation')
        ...
        .controller('MaterialLoginCtrl', ['$scope', '$location', MaterialLoginCtrl])
        .controller('MaterialSignUpCtrl', ['$scope', '$location', MaterialSignUpCtrl])
        .controller('MaterialResetCtrl', ['$scope', '$location', MaterialResetCtrl])
    ...
    function MaterialLoginCtrl ($scope, $location) {
        var original;
    ...
    function MaterialSignUpCtrl ($scope, $location) {
        var original;
    ...
    function MaterialResetCtrl ($scope, $location) {
        var original;
